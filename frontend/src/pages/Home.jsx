    ...
    <div>
      ...
      <div className="flex flex-col gap-6 py-28 px-3 max-w-6xl mx-auto">
        ...
        <div className="text-gray-400 text-xs sm:text-sm ">
          Sadan Estate is the best place to find your next perfect place to live. <br />
          ...
          offerListings && offerListings.length > 0 &&(
            <div className="">
              <div className="my-3">
                ...
                <Link to={'/search?offer=true'} className='text-sm text-blue-800 hover:underline'> Show more offers
                </Link>
              </div>
          ...
          rentListings && rentListings.length > 0 &&(
            <div className="">
              <div className="my-3">
                ...
                <Link to={'/search?type=rent'} className='text-sm text-blue-800 hover:underline'> Show more place for rent
                </Link>
              </div>
              <div className="flex flex-wrap gap-4">
                {
          ...
          saleListings && saleListings.length > 0 &&(
            <div className="">
              <div className="my-3">
                ...
                <Link to={'/search?type=sale'} className='text-sm text-blue-800 hover:underline'> Show more places for sale
                </Link>
              </div>
              <div className="flex flex-wrap gap-4">
                {
